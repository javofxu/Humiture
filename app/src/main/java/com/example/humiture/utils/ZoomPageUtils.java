 ...
 * Created by 许格.
 * Date on 2019/5/16.
 * dec:3D画廊效果其实就是ViewPager的item切换时，进行缩放的动画效果
 */
public class ZoomPageUtils implements ViewPager.PageTransformer {
    ...
    public ZoomPageUtils() {
    }
    public ZoomPageUtils(float MIN_ALPHA) {
